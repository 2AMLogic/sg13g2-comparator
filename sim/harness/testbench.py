...
Ported, PDK-agnostic, from ``2AMLogic/gf180-comparator``'s
``sim/harness/testbench.py`` (itself ported from
``2AMLogic/gf180-sar-adc``'s harness): nothing here names gf180mcu or
SG13G2 specifically, so nothing needed to change.
"""
